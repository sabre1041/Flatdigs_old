                ...
                <div class="dialog">
                    <table>
                        <tbody>
                            ...
                            <tr class="prop">
                                <td valign="top" class="name">
                                    <label for="creditScore"><g:message code="user.creditScore.label" default="Credit Score" /></label>
                                </td>
                                <td valign="top" class="value ${hasErrors(bean: userInstance, field: 'creditScore', 'errors')}">
                                    <g:textField name="creditScore" value="${fieldValue(bean: userInstance, field: 'creditScore')}" />
                                </td>
                            </tr>
