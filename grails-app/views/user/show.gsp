...
<%@ page import="com.flatdigs.auth.User" %>
<html>
    <head>
            ...
            <div class="dialog">
                <table>
                    <tbody>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="user.creditScore.label" default="Credit Score" /></td>
                            
                            <td valign="top" class="value">${fieldValue(bean: userInstance, field: "creditScore")}</td>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="user.props.label" default="Props" /></td>
                            
                            <td valign="top" style="text-align: left;" class="value">
                                <ul>
                                <g:each in="${userInstance.props}" var="p">
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="user.units.label" default="Units" /></td>
                            
                            <td valign="top" style="text-align: left;" class="value">
                                <ul>
                                <g:each in="${userInstance.units}" var="u">
